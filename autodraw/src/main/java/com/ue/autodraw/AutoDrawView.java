 ...
 */
public class AutoDrawView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public AutoDrawView(Context context, AttributeSet attrs, int defStyleAttr) {
