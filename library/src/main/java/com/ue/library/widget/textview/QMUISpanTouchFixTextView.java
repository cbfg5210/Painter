package com.ue.library.widget.textview;
...
import com.ue.library.span.QMUITouchableSpan;
import com.ue.library.link.QMUILinkTouchMovementMethod;
 ...
 */
public class QMUISpanTouchFixTextView extends android.support.v7.widget.AppCompatTextView implements ISpanTouchFix {
    /**
    ...
    public void setMovementMethodDefault(){
        setMovementMethodCompat(QMUILinkTouchMovementMethod.Companion.getInstance());
    }
