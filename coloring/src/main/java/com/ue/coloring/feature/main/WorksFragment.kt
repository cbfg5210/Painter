...
import kotlinx.android.synthetic.main.co_fragment_works.view.*
import kotlinx.android.synthetic.main.co_layout_empty.view.*
...
class WorksFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val rootView = inflater.inflate(R.layout.co_fragment_works, container, false)
    ...
    private fun loadLocalWorks() {
        ...
        disposable = Observable
                ...
                .subscribe({ mLocalWorks ->
                    ...
                    Toast.makeText(context, getString(R.string.co_read_data_error, t.message), Toast.LENGTH_SHORT).show()
                })
    }
