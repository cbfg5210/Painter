...
import kotlinx.android.synthetic.main.co_item_picked_color.view.*
...
class PickedColorAdapter(context: Context) : RecyclerView.Adapter<PickedColorAdapter.ViewHolder>() {
    ...
    init {
        ...
        if (TextUtils.isEmpty(pickedColorsStr)) {
            val pickedColorsTa = context.resources.obtainTypedArray(R.array.co_defPickedColors)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.co_item_picked_color, parent, false)
