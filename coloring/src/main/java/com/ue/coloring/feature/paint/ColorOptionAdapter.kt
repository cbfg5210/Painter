...
import kotlinx.android.synthetic.main.co_item_color_option.view.*
...
class ColorOptionAdapter(context: Context) : RecyclerView.Adapter<ColorOptionAdapter.ViewHolder>() {
    ...
    init {
        val paintColorsTa = context.resources.obtainTypedArray(R.array.co_paintColors)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.co_item_color_option, parent, false)
